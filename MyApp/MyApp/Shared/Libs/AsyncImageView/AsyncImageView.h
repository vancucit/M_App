...
@end
@protocol AsynImageViewUpdateContrainDelegate <NSObject>

- (void)willChangeConstraintHeigh:(CGFloat)newHeigh;
...
@property (nonatomic, assign) BOOL isCircleImage;
@property (nonatomic, assign) BOOL displayRealSize;
@property (nonatomic, weak) id<AsynImageViewUpdateContrainDelegate> delegateConstraint;
