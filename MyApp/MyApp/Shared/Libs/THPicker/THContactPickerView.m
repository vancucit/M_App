...
- (void)textViewDidBeginEditing:(UITextView *)textView{
    if ([_delegate respondsToSelector:@selector(contactPickerDidDidBeginEditing:)]) {
        [_delegate contactPickerDidDidBeginEditing:textView];
    }
}

- (void)textViewDidEndEditing:(UITextView *)textView{
    if ([_delegate respondsToSelector:@selector(contactPickerDidEndEditing:)]) {
        [_delegate contactPickerDidEndEditing:textView];
    }
}
